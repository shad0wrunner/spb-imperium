...
В игре присутствовало два типа специальных систем: астероидные поля и сверхновая.
...
Добавили две фракции (Л1з1кс и Наалу). Однако основным содержимым игры был набор новых тайлов для добавления ещё одного ряда при составлении поля, соответствующий этому набору вариант для игра на 7-8 игроков (не требующий, в отличии от варианта из Distant Suns двух копий базы), а так же "малые расы", которые могли жить в этом ряду.  
