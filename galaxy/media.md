...
Для победы игрок должен был продвигать свою фракцию по Progression Chart от Warlord до Imperium Rex. Кто первый достигнет (ну или уничтожит всех остальных), тот и выиграет. При равенстве побеждал игрок с наибольшим влиянием.  
Карта создавалась похожим способом, что и во всех остальных редакциях, только очерёдность выкладки определялась наименьшим броском на кубиках.  
Из отрядов в игре были пехотинцы, истребители, транспорты, крейсера и дредноуты.  
Игроки могли передавать друг другу кредиты и карты действия, но только во время специальной фазы.  
Для получения кредитов, приобретения технологических улучшений, производства и выставления отрядов существовали свои отдельные фазы (для кредитов даже целых две - одна по ресурсам планет, вторая по торговым соглашениям).  
Технологическое древо было плоским с тремя ветками.  
В фазе политики игроки голосовали либо всем своим влиянием, либо не голосовали. Голосовали в порядке от игрока с наименьшим влиянием к наибольшему.  
В игре присутствовало два типа специальных систем: сверхновые (через которые вообще нельзя было перемещаться) и астероидные поля (через которые можно было перемещаться только с технологией Antimass Deflectors).

К игре было выпущено 4 дополнения, одно из которых представлял собой просто набор пластиковых фигурок для игры. Первое дополнение рекламировали сразу в базе (причем домашние системы для Ментака и Иссарила даже были включены в игру, но играть за них было нельзя).
...
Добавили две фракции (Ментак и Иссарил), новые карты политики (x16) и действий (x16), несколько опциональных правил: мины; убийцы и телохранители в фазе политики; sustain damage для транспортов и дредноутов; продвинутое строительство; планеты-столицы; объявление войны и мира.

### [Twilight Imperium: Distant Suns (1998)](https://boardgamegeek.com/boardgameexpansion/6181/twilight-imperium-distant-suns)
В этом дополнение в серии впервые появилось опциональное правило для исследования планет - Distant Suns. Дополнительно к нему было выпущено опциональное правило Propaganda, влиявшее на получение ресурсов с планет. Так же впервые появились защитники Мекатол Рекса. Добавился режим игры на 7-8 игроков, для которого нужно было 2 копии базовой игры и одна копия дополнения Borderlands. Ещё одно опциональное правило, Empire's End, ввели для ускорения игры.
...
Добавили две фракции (Л1З1КС и Наалу). Однако основным содержимым дополнения был набор новых тайлов для добавления ещё одного ряда при составлении поля, соответствующий этому набору вариант игры на 7-8 игроков (не требующий, в отличии от варианта из Distant Suns двух копий базы), а также "малые расы", которые могли жить в этом ряду.  
Добавилось два новых типа тайлов: Nebula (x2) и Gravity Rift (x1). Через туманность нельзя было пролетать и истребители при сражении в ней не кидали кубики. На вылет из гравитационного колодца игрок кидал кубик и при выпадении 1-6 корабль мог вылететь только в конкретный тайл (или остаться в колодце), а при 7-10 - в любой по выбору игрока.  
...
Карта впервые начала составляться змейкой.  
Две фазы получения кредитов (с планет и торговых соглашений) были объединены в одну.  
А вот технологии претерпели существенное измнение, и стали представлены тем деревом, которое позже перекочевало в третью редакцию. Кроме того, у планет появились технологические специализации.  
