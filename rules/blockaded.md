...
См.также: [База](space_dock.md), [Захват](capture.md), [Корабли](ships.md), [Отряды](units.md), [Производство (Способность)](production_abil.md), [Снабжение](reinforcements.md).
